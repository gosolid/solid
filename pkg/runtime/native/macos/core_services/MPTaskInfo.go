...
/*
struct CoreServices.MPTaskInfo
*/
...
type MPTaskInfo struct {
  ...
  BlockedObject *OpaqueMPOpaqueID `v8:"blockedObject"`
  SpaceID *OpaqueMPAddressSpaceID `v8:"spaceID"`
  StackBase *void `v8:"stackBase"`
  StackLimit *void `v8:"stackLimit"`
  StackCurr *void `v8:"stackCurr"`
}
