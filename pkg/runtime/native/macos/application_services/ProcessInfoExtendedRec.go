...
/*
struct ApplicationServices.ProcessInfoExtendedRec
*/
...
type ProcessInfoExtendedRec struct {
  ...
  ProcessTempMemTotal uint `v8:"processTempMemTotal"`
  ProcessPurgeableTempMemTotal uint `v8:"processPurgeableTempMemTotal"`
}
