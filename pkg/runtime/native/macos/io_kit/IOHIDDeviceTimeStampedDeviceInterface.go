...
/*
struct IOKit.IOHIDDeviceTimeStampedDeviceInterface
*/

type IOHIDDeviceTimeStampedDeviceInterface struct {
  ...
  SetInputReportWithTimeStampCallback func(...any) (any, error) `v8:"setInputReportWithTimeStampCallback"`
}
