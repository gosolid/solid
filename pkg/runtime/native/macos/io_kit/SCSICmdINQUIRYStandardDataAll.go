...
/*
struct IOKit.SCSICmd_INQUIRY_StandardDataAll
*/

type SCSICmdINQUIRYStandardDataAll struct {
  ...
  VendorSpecific1 [20]byte `v8:"vendorSpecific1"`
  Flags3 byte `v8:"flags3"`
  Reserved1 byte `v8:"reserved1"`
  VERSIONDESCRIPTOR [8]uint16 `v8:"vERSIONDESCRIPTOR"`
  Reserved2 [22]byte `v8:"reserved2"`
  VendorSpecific2 [160]byte `v8:"vendorSpecific2"`
}
